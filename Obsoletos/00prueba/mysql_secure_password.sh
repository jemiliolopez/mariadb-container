...
# sh-4.2$ cat /opt/rh/rh-mariadb103/root/usr/bin/mysql_secure_installation
...
then
  ...
  print_defaults="/opt/rh/rh-mariadb103/root/usr/bin/my_print_defaults"
  mysql_command="/opt/rh/rh-mariadb103/root/usr/bin/mysql"
fi
